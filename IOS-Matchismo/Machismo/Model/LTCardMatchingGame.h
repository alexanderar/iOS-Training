...
///Abstract object that represents any card matching game.
///All particular games should derive from this object.
...
///Chooses a card at specific \c index.
///Once number of chosen cards reaches an allowed number of chosen cards that is configured for
///the game, matchisng logic is triggerd.
- (void)chooseCardAtIndex:(NSUInteger) index;

///Creates a deck of cards.
///Abstract method that should be implemented in derived class.
- (LTDeck *)createDeck;

///Returns a matching score for the cards provided in \cards array.
///Abstract method that should be implemented in derived class.
